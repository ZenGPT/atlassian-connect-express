...
module.exports = function (config, mode, overrides) {
  ...
  return _.extend({}, wrap(globalValues), wrap(modeValues), {
    ...
    errorTemplateName() {
      return (modeValues.errorTemplateName) ? modeValues.errorTemplateName : defaults.errorTemplateName;
    },

    errorTemplateObject() {
      return (modeValues.errorTemplateObject) ? modeValues.errorTemplateObject : defaults.errorTemplateObject;
    },
